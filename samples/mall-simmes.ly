...
m =  { \time 4/4
       ...
       bes'\middle << { g8~ g4\adjustEndpoints #'((-2.5 . 1) . (0 . 0)) } \\ { r8 d'\middle g'\index } >> a'\middle\arpAbove f8 a d'\index
       ...
       << { bes,2.\adjustEndpoints #'((0 . 0) . (0 . -3)) } \\ { bes8.\arpAbove c'16\index d'8 ees'\index f' d'\index } >> bes4\arpAbove
       ...
       <g, g> a\index bes c'\index d'8\arpAbove c'16 bes << { d4\adjustEndpoints #'((0 . 0) . (0 . -1.5)) } \\ { a16 g\index a bes\index } >> a16 fis\index d8
       ...
       << { bes,2.\adjustEndpoints #'((0 . 0) . (0 . -4)) } \\ { bes,16 bes\index bes c'\index d' c'\index d' ees'\index f' ees'\index d' c'\index } >> bes4\arpAbove
